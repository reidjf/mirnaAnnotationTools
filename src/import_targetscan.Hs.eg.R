#############################################################
## import_targetscan.Hs.eg.R                               ##
##  create annotation package for targetscan (Human)       ##
##  database using AnnotationDbi.                          ##
##                                                         ##
## Author: James F. Reid <james.reid@ifom-ieo-campus.it>   ##
## Created: Mar 2010                                       ##
## Time-stamp: <2011-04-01 10:26:19 (jfr)>                 ##
##                                                         ##
...
targetscanCurrent1 <- "vert_50/vert_50_data_download"
targetscanCurrent2 <- "cgi-bin/targetscan/data_download.cgi?db=vert_50"
dbFTP              <- sprintf("http://%s/%s/", targetscanDomain,
                              targetscanCurrent1)
dbTitle           <- "TargetScan miRNA target predictions for human"
dbAnnObjTarget    <- "TargetScan (Human)"
